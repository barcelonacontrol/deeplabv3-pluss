...
class DeepLab(nn.Module):
    ...
    def forward(self, x):
        ...
        draw_features(8, 8, x.cpu().numpy(), "{}/out.png".format(savepath))
        x = self.cls_conv(x)
...
savepath = r'cam_map'
model   = DeepLab(num_classes=num_classes, backbone=backbone, downsample_factor=downsample_factor, pretrained=pretrained).cuda()
model.eval()
